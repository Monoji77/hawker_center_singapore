...
# api_key = as.vector(read.table("censusmapper.txt", header = FALSE))[[1]]
# options(cancensus.api_key = api_key)


# to pull year census data 
# specify region to obtain data from
dataset_var = "CA21"
...
# write to csv
st_write(census21_data, "../../census21_data.shp")
getwd()
...
# write to csv
write.csv(census06_data, "census06_data.csv")
